...
path_quest_final = "GW_MODELING/BC_intro/QUESTIONS/bc_intro_final_ass.json"
...
#        turn = st.toggle("Rotate to h–Q", value=False, key=f"intro_turn_{key_suffix}")
    ...
    show_tree = True
    tree_path = "GW_MODELING/BC_intro/FIGS/tree-23.png"
    tree_x1    = 500
    tree_zoom1 = 0.4
    tree_x2    = 1100
    tree_zoom2 = 0.3
...
with columns_fig0[1]:
    st.image('GW_MODELING/BC_intro/FIGS/stream_groundwater_BC.png')
...
with columns_fig2[0]:
    st.image('GW_MODELING/BC_intro/FIGS/Well01.jpg')
    st.markdown(":green[*An abstraction well in a mining area.*]")
with columns_fig2[1]:
    st.image('GW_MODELING/BC_intro/FIGS/Precipitation01.jpg')
    st.markdown(":green[*Precipitation resulting in groundwater recharge.*]")
with columns_fig2[2]:
    st.image('GW_MODELING/BC_intro/FIGS/Evapo01.jpg')
...
with columns_fig3[0]:
    st.image('GW_MODELING/BC_intro/FIGS/Lake03.jpg')
...
with columns_fig4[1]:
    st.image('GW_MODELING/BC_intro/FIGS/GWF_EX01.jpg')
...
with columns_lic[1]:
    st.image('GW_MODELING/BC_intro/FIGS/CC_BY-SA_icon.png')