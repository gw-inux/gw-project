...
path_quest_ini   = "GW_MODELING/GWP_Boundary_Conditions/questions/initial_drn.json"
path_quest_exer =  "GW_MODELING/GWP_Boundary_Conditions/questions/exer_drn.json"
path_quest_final = "GW_MODELING/GWP_Boundary_Conditions/questions/final_drn.json"
...
with st.expander("Tell me more about **the :green[application of DRN in Field-Scale Groundwater Modeling]**", icon ="🌍"):
    ...
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/DRNspring1.png', caption="Illustration of water table rising above the ground surface because there is no mechanism to allow groundwater outflow.")
    left_co, cent_co, last_co = st.columns((10,40,10))
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/DRNspring2.png', caption="Illustration of springs developing at the ground surface when the water table rises.")
    ...
    left_co, cent_co, last_co = st.columns((10,40,10))
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/DRNapplied1.png', caption="Illustration of a GHB boundary used to represent a swamp allowing exchange of water between the swamp and groundwater system.")
    ...
    left_co, cent_co, last_co = st.columns((10,40,10))
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/DRNapplied2.png', caption="Illustration of a GHB boundary resulting in overestimation of mine inflow.")
    ...
    left_co, cent_co, last_co = st.columns((10,40,10))
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/DRNapplied3.png', caption="Illustration of a DRN representing a swamp such that it goes dry when groundwater levels decline.")
...
with st.expander("Show me more about **the Theory**", icon ="📑"):
    ...
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/DRN.png', caption="Schematic of the DRN boundary with (a) drain pipe buried in a backfilled ditch, and (b) an open drain at the ground surface (modified from McDonald and Harbaugh, 1988)")
    st.markdown("""
...
with st.expander('**Click here** to read how :green[**conductance is calculated**]', icon ="📑"):
    ...
    left_co, cent_co, last_co = st.columns((10,80,10))
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/DrainConductance.png', caption="Schematic of the DRN boundary with labels indicating parameters used to calculate conductance (modified from McDonald and Harbaugh, 1988)")
