...
path_quest_ini   = "GW_MODELING/GWP_Boundary_Conditions/questions/initial_riv.json"
path_quest_exer =  "GW_MODELING/GWP_Boundary_Conditions/questions/exer_riv.json"
path_quest_final = "GW_MODELING/GWP_Boundary_Conditions/questions/final_riv.json"
...
with cent_co:
    st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/RIV_nearWell.png', caption="Conceptual illustration of the river/groundwater interaction.")
with st.expander("Tell me more about **the :violet[application of RIV in Field-Scale Groundwater Modeling]**", icon ="🌍"):
    ...
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/river_field_application.jpg', caption="Example illustration of representing a river in a field-scale model (from Morway et al., 2016).")
    st.markdown("""
...
with st.expander("Show me more about **the Theory**", icon ="📑"):
    ...
    left_co, cent_co, last_co = st.columns((10,40,10))
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/RIV.png', caption="Schematic of the RIV boundary (modified from McDonald and Harbaugh, 1988)")
...
with st.expander('**Click here** to read about the :green[**elevations used**] in the River Boundary condition of MODFLOW', icon ="📑"):
    ...
    with cent_co1:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/RIV_CONCEPT_2_v3.png', caption="Concept of the River boundary (modified from McDonald and Harbaugh, 1988)")
    st.markdown("""
...
with st.expander('**Click here** to read how :green[**conductance is calculated**]', icon ="📑"):
    ...
    with cent_co2:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/RIV_COND_2.png', caption="Calculation of the Riverbed conductance (from McDonald and Harbaugh, 1988)")
...
with st.expander('**Click here** to read how flow is calculated when the :green[**groundwater head is lower than the river bottom**]', icon ="📑"):
    ...
    with cent_co3:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/RIV_CONCEPT_UNSAT_3.png', caption="Concept of the River boundary when the groundwater head falls below the river bottom (modified from McDonald and Harbaugh, 1988)")
