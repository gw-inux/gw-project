...
with left_co1:
    st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/iNUX_wLogo.png')
with cent_co1:
    st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/1200px-Erasmus+_Logo.svg.png')

st.subheader('About the Developers', divider = 'green')
    
left_co2, cent_co2 = st.columns((20,60))
with left_co2:
    st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/thomasreimann.png')
with cent_co2:
    st.markdown(
        """
...
with left_co3:
    st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/eileen.poeter.jpg')
with cent_co3:
    st.markdown(
        """
...
with left_co4:
    st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/evekuniansky.png')
with cent_co4:
    st.markdown(
        """
