...
path_quest_ini   = "GW_MODELING/GWP_Boundary_Conditions/questions/initial_ghb.json"
path_quest_exer = "GW_MODELING/GWP_Boundary_Conditions/questions/exer_ghb.json"
path_quest_final = "GW_MODELING/GWP_Boundary_Conditions/questions/final_ghb.json"
...
with cent_co:
    st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/GHBapplied0_2.png', caption="A GHB provides connection to a source or sink external to the model domain. Here, flow is from an adjacent aquifer with water supplied by a lake some distance away.")
    
left_co, cent_co, last_co = st.columns((10,40,10))
with cent_co:
    st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/GHBexampleAnderson-etal_modified2.png', caption="Mathematical illustration of a GHB (modified from Anderson et al., 2015).")
...
with st.expander("Tell me more about **the :orange[application of GHB in Field-Scale Groundwater Modeling]**", icon ="🌍"):
    ...
    left_co, cent_co, last_co = st.columns((10,40,10))
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/GHBapplied1.png', caption="GHB representation of a lake. All the cells intersecting the lake have GHBs.")
    ...
    left_co, cent_co, last_co = st.columns((10,40,10))
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/GHBapplied2.png', caption="GHB representation of inflow from an area outside of the model domain.")
    ...
    left_co, cent_co, last_co = st.columns((10,40,10))
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/GHBapplied3.png', caption="GHB representation of leakage from an underlying aquifer.")
...
with st.expander("Show me more about **the Theory**", icon ="📑"):
    ...
    with cent_co:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/GHB.png', caption="Schematic of the GHB boundary (modified from McDonald and Harbaugh, 1988)")
