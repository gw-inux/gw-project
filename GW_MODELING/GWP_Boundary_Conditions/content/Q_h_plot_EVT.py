...
path_quest_ini   = "GW_MODELING/GWP_Boundary_Conditions/questions/initial_et.json"
path_quest_exer   = "GW_MODELING/GWP_Boundary_Conditions/questions/exer_et.json"
path_quest_final = "GW_MODELING/GWP_Boundary_Conditions/questions/final_et.json"
...
with cent_co:
    st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/EVT_cartoon2.png', caption="Conceptual illustration of evapotranspiration from groundwater in MODFLOW with maximum ET when the water table is at or above the ET surface, zero ET when it is below the extinction elevation and intermediate ET when the water table is between the ET surface and extinction depth.")
...
with st.expander("Show me more about **the Theory**", icon ="📑"):
    ...
    with cent_co2:
        st.image('GW_MODELING/GWP_Boundary_Conditions/assets/images/gwp_boundary_EVT.png', caption="Schematic of the EVT boundary (modified from MODFLOW6 documentation by Langevin et al., 2017)")
