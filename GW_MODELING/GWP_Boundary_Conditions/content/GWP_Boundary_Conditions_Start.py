...
👉 For users who are completely new to the topic, a separate [introductory application](https://gwp-boundary-conditions-intro.streamlit.app/) is available that provides a visual explanation of the fundamental concepts of boundary conditions before exploring their implementation in groundwater models.
